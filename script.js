window.addEventListener('load', () => {
	...
	let dice = {
		d20: { 
			value: 20, 
			label: 'D20', 
			image: 'https://drive.google.com/uc?export=view&id=1Cdv19qd-HBZSnrfe2hkunU3bsPZ7VPht',
		},
		d12: { 
			value: 12, 
			label: 'D12', 
			image: 'https://drive.google.com/uc?export=view&id=1gRMfOlt98M5dmc-Ex5enZRFy7Bkkr9ta',
		},
		d10: { 
			value: 10, 
			label: 'D10', 
			image: 'https://drive.google.com/uc?export=view&id=1iwbOiPeNMREcQswWeLZ-dDJXzoaozVum',
		},
		d8: { 
			value: 8, 
			label: 'D8', 
			image: 'https://drive.google.com/uc?export=view&id=1LrjniIM1RG4u8as6hT5Pa-nS_1z0Bt5z',
		},
		d6: { 
			value: 6, 
			label: 'D6', 
			image: 'https://drive.google.com/uc?export=view&id=1KABrJFwctJG8JlLhL8ZXYIjj4-a2Gd64',
		},
		d4: { 
			value: 4, 
			label: 'D4', 
			image: 'https://drive.google.com/uc?export=view&id=1TywBsbvDZ8IMiz_7UNQJJS88FTd2kDTN',
		},
	};
